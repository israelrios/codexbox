...
ARG INSTALL_RPMS="podman podman-docker bubblewrap fuse-overlayfs slirp4netns passt openssh-clients cpp git-core sqlite python3 python3-pip python3-pytest nodejs ripgrep jq gcc gcc-c++ make procps-ng gh glab ShellCheck python3-pyyaml"
